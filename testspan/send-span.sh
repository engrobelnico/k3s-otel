...
SendSpan(){
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverURI --data "@./test-client.json" -H  "accept: application/json" -H  "Content-Type: application/json"
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverURI --data "@./test-server.json" -H  "accept: application/json" -H  "Content-Type: application/json"
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverURI --data "@./test-server2.json" -H  "accept: application/json" -H  "Content-Type: application/json"
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverURI --data "@./test-remoteserver.json" -H  "accept: application/json" -H  "Content-Type: application/json"
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverURI --data "@./test-server3.json" -H  "accept: application/json" -H  "Content-Type: application/json"
    ...
    curl --insecure --write-out "%{http_code}\n" -X POST $serverOTEL --data "@./test-otel.json" -H  "accept: application/json" -H  "Content-Type: application/json"
